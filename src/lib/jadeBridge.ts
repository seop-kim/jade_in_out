...
export class JadeBridgeClient implements JadeBridgeTransport {
  ...
  private handleMessage(event: MessageEvent): void {
    if (event.origin !== JADE_BRIDGE_ORIGIN || event.source !== this.tab) return;
